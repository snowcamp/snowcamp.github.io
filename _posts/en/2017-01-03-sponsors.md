    ...
    <div class="row centered">
      <div class="four wide column">
        <a href="http://www.alpesjug.org/" target="_blank" title="AlpesJUG">
          <img class="ui image" src="{{ site.url }}/assets/themes/snowcamp/skin/sponsors/2017/alpesjug_logo.jpeg" />
        </a>  
      </div>
      <div class="four wide column">
      ...
      <div class="four wide column">
        <a href="http://www.clubagilerhonealpes.org/" target="_blank" title="CARA: Club Agile Rhône-Alpes">
          <img class="ui image" src="{{ site.url }}/assets/themes/snowcamp/skin/sponsors/2017/cara_logo.png" />
        </a>
      </div>
    </div>
  </div>
