...
<div class="ui inverted vertical masthead center aligned segment">
  ...
  <div class="ui text container">
    ...
    <h2>Schedule is now available! Have a look at it!</h2>
  ...
  <div class="ui middle aligned center stackable grid container" style="padding-top: 5px; padding-bottom: 5px; margin-bottom: 15px">
      <div class="row centered">
        <div class="six wide column">
          <div class="ui card">
            <h2>And the day before... 7th of February</h2>
            <div class="image">
            ...
            <div class="content" style="margin-top: 20px">
              ...
              <a class="ui button" href="http://ypl.me/3ro" target="blank">Tickets Here</a>
            </div>
          </div>
        </div>
        <!-- <div class="six wide column">
          <div class="ui card">
            <h2>8th afternoon of February</h2>
            <div class="image">
